            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
					...
					<li class="xn-openable">
                        ...
                        <ul>
                            <li><a href="<?php echo site_url('applicant/applicantIQScores') ?>"><span class="fa fa-plus"></span> Assessment Scores</a></li>
                            <li><a href="#"><span class="fa fa-eye"></span> Registered Applicants</a></li>               
                        </ul>
                    </li>
					...
					<li class="xn-openable">
                        ...
                        <ul>
                            <li><a href="#"><span class="fa fa-plus"></span> Courses</a></li>
                            <li><a href="#"><span class="fa fa-eye"></span> Applied Courses</a></li>               
                        </ul>
                    </li>
