			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>You are to choose the next diagram in the series from the five options presented. Please select one correct answer.</p>
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							...
							<div class="radio"><label><input type="radio" name="q1" value="5" > D</label></div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							...
							<div class="radio"><label><input type="radio" name="q2" value="5" > D</label></div>
...
<div class="container" id="cont-3" style="display:none">
		<form role="form" id="form-3" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q3" value="5" > A</label></div>
...
<div class="container" id="cont-5" style="display:none">
		<form role="form" id="form-5" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q5" value="5" > A</label></div>
							<div class="radio"><label><input type="radio" name="q5" value="0" > B</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Please enter the missing figure: 
						<br>
						<span style="font-weight:bold; color:gray">3,&nbsp;&nbsp;&nbsp; 5, &nbsp;&nbsp;&nbsp; 8, &nbsp;&nbsp;&nbsp; 13, &nbsp;&nbsp;&nbsp; 	21,  &nbsp;&nbsp;&nbsp; ?</span>
						</p>
					</div>
				</div>
				<!--<div class="col-xs-12 col-sm-6 col-md-8">
				...
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q6" value="5" > A 34</label></div>
							<div class="radio"><label><input type="radio" name="q6" value="0" > B 24</label></div>
							<div class="radio"><label><input type="radio" name="q6" value="0" > C 35</label></div>
							<div class="radio"><label><input type="radio" name="q6" value="0" > D 41</label></div>
							<div class="radio"><label><input type="radio" name="q6" value="0" > E 44</label></div>
					</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Please enter the missing figure: <br>
						<span style="font-weight:bold; color:gray">0.1, &nbsp;&nbsp;&nbsp; 0.3, &nbsp;&nbsp;&nbsp; 0.5, &nbsp;&nbsp;&nbsp; 0.7, &nbsp;&nbsp;&nbsp; 0.9,  &nbsp;&nbsp;&nbsp; ?</span>
						</p>
					</div>
				</div>
				<!--<div class="col-xs-12 col-sm-6 col-md-8">
				...
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q7" value="0" >	A 0.11</label></div>
							<div class="radio"><label><input type="radio" name="q7" value="5" >	B 1.1</label></div>
							<div class="radio"><label><input type="radio" name="q7" value="0" >	C 11</label></div>
							<div class="radio"><label><input type="radio" name="q7" value="0" >	D 0.011</label></div>
							<div class="radio"><label><input type="radio" name="q7" value="0" >	E 11.0</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>What is the result of multiplying all figures from 0 to 25?</p>
					</div>
				</div>
				<!--<div class="col-xs-12 col-sm-6 col-md-8">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q8" value="0" > A 25</label></div>
							<div class="radio"><label><input type="radio" name="q8" value="5" > B 0</label></div>
							<div class="radio"><label><input type="radio" name="q8" value="0" > C 50</label></div>
							<div class="radio"><label><input type="radio" name="q8" value="0" > D   1</label></div>
							<div class="radio"><label><input type="radio" name="q8" value="0" > E 125</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>A trader buys tea for N1200 and sells it for N1500. Per sack of tea he makes a profit N50. How many sacks of tea did he have?
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q9" value="0" > A 300</label></div>
							<div class="radio"><label><input type="radio" name="q9" value="0" > B 5</label></div>
							<div class="radio"><label><input type="radio" name="q9" value="5" > C 6</label></div>
							<div class="radio"><label><input type="radio" name="q9" value="0" > D  20</label></div>
							<div class="radio"><label><input type="radio" name="q9" value="0" > E 10</label></div>
...
<div class="container" id="cont-10" style="display:none">
		<form role="form" id="form-10" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q10" value="0" > A 360/420</label></div>
							<div class="radio"><label><input type="radio" name="q10" value="0" > B 18/21</label></div>
							<div class="radio"><label><input type="radio" name="q10" value="0" > C 340/21</label></div>
							<div class="radio"><label><input type="radio" name="q10" value="5" > D 17/420</label></div>
							<div class="radio"><label><input type="radio" name="q10" value="0" > E 20/210</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Find the word not matching the other words (odd one out): 
						<br>
						<span style="font-weight:bold; color:gray">London, &nbsp;&nbsp;&nbsp; Paris, &nbsp;&nbsp;&nbsp; Lagos, &nbsp;&nbsp;&nbsp; Lomé, &nbsp;&nbsp;&nbsp; Nairobi</span>
						</p>
					</div>
				</div>
				<!--<div class="col-xs-12 col-sm-6 col-md-8">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q11" value="5" > A – Lagos</label></div>
							<div class="radio"><label><input type="radio" name="q11" value="0" > B – Paris</label></div>
							<div class="radio"><label><input type="radio" name="q11" value="0" > C – Lomé</label></div>
							<div class="radio"><label><input type="radio" name="q11" value="0" > D – Nairobi</label></div>
							<div class="radio"><label><input type="radio" name="q11" value="0" > E – Ghana</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Find the word not matching the other words (odd one out): 
						<br>
						<span style="font-weight:bold; color:gray">palm oil, &nbsp;&nbsp;&nbsp; maize, &nbsp;&nbsp;&nbsp; rice, &nbsp;&nbsp;&nbsp; yam, &nbsp;&nbsp;&nbsp; petroleum</span>
						</p>
					</div>
				</div>
				<!--<div class="col-xs-12 col-sm-6 col-md-8">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					...
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q12" value="0" > A Maize</label></div>
							<div class="radio"><label><input type="radio" name="q12" value="5" > B Rice</label></div>
							<div class="radio"><label><input type="radio" name="q12" value="0" > C  Yam</label></div>
							<div class="radio"><label><input type="radio" name="q12" value="0" > D Palm Oil</label></div>
							<div class="radio"><label><input type="radio" name="q12" value="0" > E Cocoa</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Find the word not matching the other words (odd one out): 
						<br>
						<span style="font-weight:bold; color:gray">Burkina Faso, &nbsp;&nbsp;&nbsp; Guinea-Bissau, &nbsp;&nbsp;&nbsp; Côte d'Ivoire, &nbsp;&nbsp;&nbsp; Ghana, &nbsp;&nbsp;&nbsp; Gabon</span>
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					...
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q13" value="0" > A - Burkina Faso</label></div>
							<div class="radio"><label><input type="radio" name="q13" value="0" > B - Guinea-Bissau</label></div>
							<div class="radio"><label><input type="radio" name="q13" value="0" > C - Côte d'Ivoire </label></div>
							<div class="radio"><label><input type="radio" name="q13" value="5" > D - Gabon </label></div>
							<div class="radio"><label><input type="radio" name="q13" value="0" > E – Nigeria</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>If you rearrange the letters <span style="font-weight:bold; color:gray">"ANLDEGN,"</span> you would have the name of a(n):</p>
					</div>
				</div>
				<!--<div class="col-xs-12 col-sm-6 col-md-8">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					...
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q14" value="0" > A Ocean</label></div>
							<div class="radio"><label><input type="radio" name="q14" value="5" > B Country</label></div>
							<div class="radio"><label><input type="radio" name="q14" value="0" > C Animal</label></div>
							<div class="radio"><label><input type="radio" name="q14" value="0" > D 	State</label></div>
							<div class="radio"><label><input type="radio" name="q14" value="0" > E Food</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Assume that these two statements are true: <span style="font-weight:bold; color:gray">All brown-haired men have bad tempers. Larry is a brown-haired man. </span> The statement Larry has a bad temper is: 
						<br>
				...
				<div class="col-xs-12 col-sm-6 col-md-8" >
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q15" value="5" > A – True</label></div>
							<div class="radio"><label><input type="radio" name="q15" value="0" > B – False</label></div>
							<div class="radio"><label><input type="radio" name="q15" value="0" > C - Unable to determine</label></div>
							<div class="radio"><label><input type="radio" name="q15" value="0" > D - Confusing</label></div>
							<div class="radio"><label><input type="radio" name="q15" value="0" > E – Maybe</label></div>
...
<div class="container" id="cont-16" style="display:none">
		<form role="form" id="form-16" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q16" value="5" > A Accommodation</label></div>
							<div class="radio"><label><input type="radio" name="q16" value="0" > B Acomodation</label></div>
							<div class="radio"><label><input type="radio" name="q16" value="0" > C Accomodation</label></div>
							<div class="radio"><label><input type="radio" name="q16" value="0" > D Accomodation</label></div>
							<div class="radio"><label><input type="radio" name="q16" value="0" > E Acomoodation</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Which of the following is correct?
						<br>
				...
				<div class="col-xs-12 col-sm-6 col-md-8" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q17" value="0" > A - Asessment</label></div>
							<div class="radio"><label><input type="radio" name="q17" value="5" > B - Assessment</label></div>
							<div class="radio"><label><input type="radio" name="q17" value="0" > C - Assesment</label></div>
							<div class="radio"><label><input type="radio" name="q17" value="0" > D - Ascessment</label></div>
							<div class="radio"><label><input type="radio" name="q17" value="0" > E - Accesment </label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Choose the word or phrase that means the same as the phrasal verb used.
						<br>
				...
				<div class="col-xs-12 col-sm-6 col-md-8" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q18" value="0" > A - have good grades.</label></div>
							<div class="radio"><label><input type="radio" name="q18" value="0" > B - make money</label></div>
							<div class="radio"><label><input type="radio" name="q18" value="5" > C - gather courage</label></div>
							<div class="radio"><label><input type="radio" name="q18" value="0" > D - Turned into a monster</label></div>
							<div class="radio"><label><input type="radio" name="q18" value="0" > E - Felt scared</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>I _______________ TV when the telephone rang.  </p>
					</div>
				</div>
				<!--<div class="col-xs-12 col-sm-6 col-md-8">
				...
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q19" value="0" > A watched</label></div>
							<div class="radio"><label><input type="radio" name="q19" value="5" > B was watching</label></div>
							<div class="radio"><label><input type="radio" name="q19" value="0" > C are watching</label></div>
							<div class="radio"><label><input type="radio" name="q19" value="0" > D have watched</label></div>
							<div class="radio"><label><input type="radio" name="q19" value="0" > E watches</label></div>
					</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Laolu has _______ friends in Kenya. </p>
					</div>
				</div>
				<!--<div class="col-xs-12 col-sm-6 col-md-8">
				...
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q20" value="5" > A few</label></div>
							<div class="radio"><label><input type="radio" name="q20" value="0" > B few of</label></div>
							<div class="radio"><label><input type="radio" name="q20" value="0" > C a lot </label></div>
							<div class="radio"><label><input type="radio" name="q20" value="0" > D Much</label></div>
							<div class="radio"><label><input type="radio" name="q20" value="0" > E a</label></div>
