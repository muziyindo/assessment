					...
					<div class="col-xs-12 col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body panel-body2">
								Thank you for signing up for the assessment, Kindly login to take the assessment.
								<br><br>
								<p>
									<center><a href="<?php echo site_url(); ?>" class="btn btn-default btn-lg" style="background: #1e3d6e; color:white; border-radius: 0"><i class="fa fa-home" aria-hidden="true"></i> Click here to Login here</a></center>
								</p>
							</div>
						</div>
