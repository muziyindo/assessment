		...
		<div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto" style="opacity:0.8 !important; width:80%; ">
			<div class="card card0 border-0">
				<div class="row d-flex">
					<div class="col-lg-6">
						<div class="card1 pb-5">
							...
							<div class="row px-3 justify-content-center mt-4 mb-5 border-line"> 
								<img src="<?php echo base_url(); ?>assets/images/stud2.jpg" class="img-fluid" width="450" height="253" style="margin-bottom:10px !important"> 
					...
					<div class="col-lg-6">
				<form action="<?php echo site_url('/site/authenticate'); ?>" method="post">
						...
						<div class="card2 card border-0 px-4 py-5">
							...
							<div class="row px-3 mb-4">
								<div class="custom-control custom-checkbox custom-control-inline"> <input id="chk1" type="checkbox" name="chk" class="custom-control-input"> <label for="chk1" class="custom-control-label text-sm">Remember me</label> </div> <a href="<?php echo site_url('site/forgetPassword'); ?>" class="ml-auto mb-0 text-sm">Forgot Password?</a>
							</div>
