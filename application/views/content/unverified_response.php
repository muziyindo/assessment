					...
					<div class="col-xs-12 col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<!--<center><i class="fa fa-check-circle" aria-hidden="true" style="font-size:60px"></i></center>-->
							</div>
							<div class="panel-body panel-body2">
								<center>You are yet to verify your account. Please check your email and click on the verification link sent to you</center>
								<br><br>
								<p>
									<center><a href="<?php echo site_url(); ?>" class="btn btn-default btn-lg" style="background: #1e3d6e; color:white; border-radius: 0"><i class="fa fa-home" aria-hidden="true"></i> Return to home</a></center>
								</p>
							</div>
						</div>
