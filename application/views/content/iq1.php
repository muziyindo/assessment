			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>This question takes the form of a 3 X 3 matrix from which one tile is missing. There are five possible answers A - E. choose the tile that completes that matrix best.</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q1.jpg" width="400" height="297"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q1" value="0" > A</label></div>
							...
							<div class="radio"><label><input type="radio" name="q1" value="5" > E</label></div>
...
<div class="container" id="cont-2" style="display:none">
		<form role="form" id="form-2" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q2.jpg" width="400" height="297"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q2" value="0" > A</label></div>
							<div class="radio"><label><input type="radio" name="q2" value="5" > B</label></div>
...
<div class="container" id="cont-3" style="display:none">
		<form role="form" id="form-3" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q3.jpg" width="400" height="297"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q3" value="0" > A</label></div>
							<div class="radio"><label><input type="radio" name="q3" value="0" > B</label></div>
							<div class="radio"><label><input type="radio" name="q3" value="5" > C</label></div>
...
<div class="container" id="cont-4" style="display:none">
		<form role="form" id="form-4" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q4.jpg" width="400" height="297"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q4" value="5" > A</label></div>
							...
							<div class="radio"><label><input type="radio" name="q4" value="0" > E</label></div>
...
<div class="container" id="cont-5" style="display:none">
		<form role="form" id="form-5" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q5.jpg" width="400" height="297"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>The white dot moves two places anti-clockwise at each stage and the black dot moves one place clockwise at each stage. After how many stages will they be together in the same corner?</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q6.jpg" width="500" height="217"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
...
<div class="container" id="cont-7" style="display:none">
		<form role="form" id="form-7" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q7.jpg" width="402" height="172"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q7" value="5" >A - 1412</label></div>
							<div class="radio"><label><input type="radio" name="q7" value="0" >B - 1016</label></div>
							<div class="radio"><label><input type="radio" name="q7" value="0" >C - 26</label></div>
							<div class="radio"><label><input type="radio" name="q7" value="0" >D - 179</label></div>
							<div class="radio"><label><input type="radio" name="q7" value="0" >E - 224</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Put the following words into alphabetical order:
						<br><span style="color:gray">Arthropod, Artificer, Arteriole, Artichoke, Arthritis, Articular, Artillery, Arthritic </span></p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-10 col-md-10">
					<!--<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q8.jpg" width="400" height="297"></img>-->
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q8" value="0" > A - Arteriole, Artichoke, Artillery, Arthritic, Arthritis, Articular, Arthropod, Artificer</label></div>
							<div class="radio"><label><input type="radio" name="q8" value="0" > B – Arteriole, Arthritic, Arthritis, Artillery, Artificer, Articular, Artichoke, Arthropod</label></div>
							<div class="radio"><label><input type="radio" name="q8" value="0" > C - Artichoke, Arthritis, Articular, Artillery, Arthritic, Arthropod, Artificer, Arteriole</label></div>
							<div class="radio"><label><input type="radio" name="q8" value="5" > D - Arteriole, Arthritic, Arthritis, Arthropod, Artichoke, Articular, Artificer, Artillery  </label></div>
							<div class="radio"><label><input type="radio" name="q8" value="0" > E - Arthropod, Artichoke, Articular, Artificer, Artillery, Arteriole, Arthritic, Arthritis</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Which two words are most opposite in meaning?
							<br><span style="color:gray">Imaginary, Realistic, Illegible, Impracticable, Radical, Embellished</span>
						</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-8">
					<!--<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q9.jpg" width="400" height="297"></img>-->
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q9" value="5" > A – Realistic, Impracticable</label></div>
							<div class="radio"><label><input type="radio" name="q9" value="0" > B – Imaginary, Embellished</label></div>
							<div class="radio"><label><input type="radio" name="q9" value="0" > C – Realistic, Illegible</label></div>
							<div class="radio"><label><input type="radio" name="q9" value="0" > D – Imaginary, Radical </label></div>
							<div class="radio"><label><input type="radio" name="q9" value="0" > E – Realistic, Imaginary</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>What numbers should replace the question marks?</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q10.jpg" width="400" height="297"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q10" value="0" > A</label></div>
							...
							<div class="radio"><label><input type="radio" name="q10" value="5" > E</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Which group of letters is the odd one out?
						<br><span style="color:gray">CEGI &nbsp;&nbsp;&nbsp;	LNPR &nbsp;&nbsp;&nbsp;	TVXZ &nbsp;&nbsp;&nbsp;	HIJK &nbsp;&nbsp;&nbsp;	PRTV &nbsp;&nbsp;&nbsp;	DFHJ</span>
</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-8">
					<!--<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q11.jpg" width="400" height="297"></img>-->
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q11" value="0" > A – DFHJ</label></div>
							<div class="radio"><label><input type="radio" name="q11" value="0" > B – LNPR</label></div>
							<div class="radio"><label><input type="radio" name="q11" value="0" > C – CEGI</label></div>
							<div class="radio"><label><input type="radio" name="q11" value="0" > D – TVXZ</label></div>
							<div class="radio"><label><input type="radio" name="q11" value="5" > E – HIJK</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>What numbers should replace the question marks?
							<br><span style="color:gray">100, 95, ?, 79, 68, ?, 40, 23</span>
						</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-8">
					...
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q12" value="0" > A – 90 & 60</label></div>
							<div class="radio"><label><input type="radio" name="q12" value="5" > B – 88 & 55</label></div>
							<div class="radio"><label><input type="radio" name="q12" value="0" > C – 86 & 53 </label></div>
							<div class="radio"><label><input type="radio" name="q12" value="0" > D – 84 &49</label></div>
							<div class="radio"><label><input type="radio" name="q12" value="0" > E – 84 &49</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>Associate is to Colleague as Accomplice is to:</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-8">
					<!--<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q13.jpg" width="400" height="297"></img>-->
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q13" value="0" > A – Consort</label></div>
							<div class="radio"><label><input type="radio" name="q13" value="0" > B – Friend</label></div>
							<div class="radio"><label><input type="radio" name="q13" value="5" > C – Accessory </label></div>
							<div class="radio"><label><input type="radio" name="q13" value="0" > D – Comrade </label></div>
							<div class="radio"><label><input type="radio" name="q13" value="0" > E – Follower</label></div>
		...
		<form role="form" id="form-14" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					...
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q14" value="5" > A – Fabulous</label></div>
							<div class="radio"><label><input type="radio" name="q14" value="0" > B – Illustrious</label></div>
							<div class="radio"><label><input type="radio" name="q14" value="0" > C – Acclaimed</label></div>
							<div class="radio"><label><input type="radio" name="q14" value="0" > D – Famous</label></div>
							<div class="radio"><label><input type="radio" name="q14" value="0" > E – Noteworthy</label></div>
...
<div class="container" id="cont-15" style="display:none">
		<form role="form" id="form-15" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q15.jpg" width="617" height="105"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold_; font-size:15px !important;">
							<div class="radio"><label><input type="radio" name="q15" value="5" > A – 6</label></div>
							<div class="radio"><label><input type="radio" name="q15" value="0" > B – 8</label></div>
							<div class="radio"><label><input type="radio" name="q15" value="0" > C – 10</label></div>
							<div class="radio"><label><input type="radio" name="q15" value="0" > D – 4</label></div>
							<div class="radio"><label><input type="radio" name="q15" value="0" > E – 2</label></div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12" >
					<div class="panel-heading">
						...
						<p>In this question you are presented with a logical sequence of five diagrams. You will need to determine which of the possible answers best matches the next diagram in the sequence or replaces the missing diagram in the sequence</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q16.jpg" width="428" height="231"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							...
							<div class="radio"><label><input type="radio" name="q16" value="0" > C</label></div>
							<div class="radio"><label><input type="radio" name="q16" value="0" > D</label></div>
							<div class="radio"><label><input type="radio" name="q16" value="5" > E</label></div>
...
<div class="container" id="cont-17" style="display:none">
		<form role="form" id="form-17" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q17.jpg" width="376" height="216"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q17" value="0" > A</label></div>
							<div class="radio"><label><input type="radio" name="q17" value="0" > B</label></div>
							<div class="radio"><label><input type="radio" name="q17" value="0" > C</label></div>
							<div class="radio"><label><input type="radio" name="q17" value="5" > D</label></div>
							<div class="radio"><label><input type="radio" name="q17" value="0" > E</label></div>
...
<div class="container" id="cont-18" style="display:none">
		<form role="form" id="form-18" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q18.jpg" width="387" height="201"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							<div class="radio"><label><input type="radio" name="q18" value="0" > A</label></div>
							<div class="radio"><label><input type="radio" name="q18" value="0" > B</label></div>
							<div class="radio"><label><input type="radio" name="q18" value="0" > C</label></div>
							<div class="radio"><label><input type="radio" name="q18" value="0" > D</label></div>
							<div class="radio"><label><input type="radio" name="q18" value="5" > E</label></div>
...
<div class="container" id="cont-19" style="display:none">
		<form role="form" id="form-19" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q19.jpg" width="406" height="237"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							...
							<div class="radio"><label><input type="radio" name="q19" value="0" > C</label></div>
							<div class="radio"><label><input type="radio" name="q19" value="5" > D</label></div>
...
<div class="container" id="cont-20" style="display:none">
		<form role="form" id="form-20" method="post">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					<img src="<?php echo base_url(); ?>assets/images/psychometric/one/q20.jpg" width="400" height="297"></img>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4" >
					<div class="panel-body" style="font-weight:bold; font-size:20px !important;">
							...
							<div class="radio"><label><input type="radio" name="q20" value="0" > D</label></div>
							<div class="radio"><label><input type="radio" name="q20" value="5" > E</label></div>
