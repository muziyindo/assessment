...
<html>
	...
	<div class="container-fluid" style="margin-top:0"><img src="<?php echo base_url(); ?>assets/images/logo.png" class="logo"  ></div>
					...
					<div class="col-lg-6">
						<div class="card1 pb-5">
							...
							<div class="row px-3 justify-content-center mt-4 mb-5 border-line"> 
								...
								<p><i class="fa fa-exclamation-triangle" aria-hidden="true" style="color:red"></i> The email address entered on the Job Application must be the same as the email entered on the assessment portal sign up form </p>
							</div>
						</div>
					</div>
					<div class="col-lg-6">
						<form action="<?php echo base_url();?>/site/registeri" method="post">
						<div class="card2 card border-0 px-4 py-5">
							...
							<div class="row mb-4 px-3">
								<div class="col-xs-12 col-md-12 col-xl-12" style="padding-left:0;">
									...
									<p>Already have an account ? <a href="<?php echo site_url(); ?>" style="color:blue"><i class="fa fa-lock" aria-hidden="true"></i> Login</p></a>
								</div>
							...
							<div class="row px-3"> <label class="mb-1">
								    ...
								    </label> <input class="mb-4" type="text" name="fname" placeholder="Enter your firstname" value="<?php echo set_value('fname'); ?>" required> 
							</div>
							<div class="row px-3"> <label class="mb-1">
									<h6 class="mb-0 text-sm">Last name</h6>
								    </label> <input class="mb-4" type="text" name="lname" placeholder="Enter your lastname" value="<?php echo set_value('lname'); ?>" required> 
							</div>
							<div class="row px-3"> <label class="mb-1">
									<h6 class="mb-0 text-sm">Position Applied for</h6>
								    </label> 
									<select class="mb-4" name="job_position"  required> 
										...
										?>
										<option value="<?php echo $value->job_id ?>"> <?php echo $value->positions ?> </option>
										<?php } ?>
							...
							<div class="row px-3"> <label class="mb-1">
								    ...
								    </label> <input class="mb-4" type="email" name="email" placeholder="Enter a valid email address" value="<?php echo set_value('email'); ?>" required> 
							</div>
							<div class="row px-3"> <label class="mb-1">
									<h6 class="mb-0 text-sm">Password</h6>
								</label> <input class="mb-4" type="password" name="password1" placeholder="Enter password" required> 
							</div>
							<div class="row px-3"> <label class="mb-1">
									<h6 class="mb-0 text-sm">Confirm password</h6>
								</label> <input class="mb-4" type="password" name="password2" placeholder="Re-enter password" required> 
							</div>
							<!--<div class="row px-3 mb-4">
		...
		<footer class="footer" style="background:#1A237E;">
      <div class="container">
